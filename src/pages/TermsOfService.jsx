      ...
      <div className="max-w-4xl mx-auto space-y-6 pb-20">
        ...
        <div className="glass glass-border rounded-2xl p-6">
          ...
          <div className="text-white/80 text-sm space-y-2">
            ...
            <p>Full details in our <a href="/popia" className="text-cyan-400 underline">POPIA Policy</a> and <a href="/docs/ISOGuardian_PAIA_Manual_v1.0.pdf" target="_blank" rel="noopener noreferrer" className="text-cyan-400 underline">PAIA Manual</a>.</p>
          </div>
        </div>
