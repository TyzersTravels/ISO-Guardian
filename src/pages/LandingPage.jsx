...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-950 to-slate-900 text-white overflow-x-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl md:text-3xl font-extrabold mb-4">
              What our clients{' '}
              <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">say</span>
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-6 hover:border-white/15 transition-all">
                ...
                <p className="text-white/60 text-sm leading-relaxed mb-4 italic">&ldquo;{t.quote}&rdquo;</p>
                <div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-slate-900/95 backdrop-blur-xl border-t border-white/10 px-4 py-2.5">
        ...
        <p className="text-center text-[10px] text-white/30 mt-1">No credit card required</p>
      </div>
