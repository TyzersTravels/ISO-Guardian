      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            className="px-3 md:px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-xl flex items-center gap-2 hover:scale-105 transition-transform shadow-lg text-sm"
          >
          ...
          <button
            ...
            className="px-3 md:px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-xl flex items-center gap-2 hover:scale-105 transition-transform shadow-lg text-sm"
          >
            <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {Object.keys(groupedDocs).length === 0 ? (
        <div className="glass glass-border rounded-2xl p-12 text-center">
          ...
          <p className="text-white/50 font-medium mb-1">
            {showArchived ? 'No archived documents' : 'No documents found'}
          </p>
          <p className="text-white/30 text-sm">
            {showArchived ? 'Archived documents will appear here.' : documents.length === 0 ? 'Upload your first document to get started.' : 'Try adjusting your search or filters.'}
          </p>
        </div>
      ) : (
              ...
              {Object.entries(clauses).map(([clause, docs]) => (
                <div key={clause} className="mb-4 last:mb-0">
                  <div className="flex items-center justify-between mb-2 gap-2">
                    <h4 className="text-base md:text-lg font-semibold text-cyan-300 truncate">
                      Clause {clause}: {docs[0].clause_name?.split(':')[1] || ''}
                    </h4>
                    <span className="text-xs md:text-sm text-white/60 flex-shrink-0">
                        ...
                        <div className="flex items-start gap-3 md:gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1 flex-wrap">
                              <span className="font-semibold text-white truncate max-w-[200px] sm:max-w-none">{doc.name}</span>
                            ...
                            <div className="flex items-center gap-2 md:gap-3 text-xs md:text-sm text-white/60 mb-2 flex-wrap">
                              <span>{doc.type}</span>
                          ...
                          <div className="grid grid-cols-3 sm:flex gap-1.5 sm:gap-2 sm:flex-wrap mt-2 sm:mt-0">
                            {!doc.archived && (
                              <>
                                <button
                                  onClick={() => handleView(doc)}
                                  className="px-2 sm:px-3 py-1.5 sm:py-2 glass glass-border text-white rounded-lg hover:bg-blue-500/20 transition-colors text-xs sm:text-sm flex items-center justify-center gap-1"
                                >
                                ...
                                <button
                                  ...
                                  className="px-2 sm:px-3 py-1.5 sm:py-2 glass glass-border text-white rounded-lg hover:bg-cyan-500/20 transition-colors text-xs sm:text-sm flex items-center justify-center gap-1"
                                >
                                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <button
                                  ...
                                  className="px-2 sm:px-3 py-1.5 sm:py-2 glass glass-border text-white rounded-lg hover:bg-red-500/20 transition-colors text-xs sm:text-sm flex items-center justify-center gap-1"
                                >
                                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <button
                                  ...
                                  className="px-2 sm:px-3 py-1.5 sm:py-2 glass glass-border text-white rounded-lg hover:bg-purple-500/20 transition-colors text-xs sm:text-sm flex items-center justify-center"
                                >
