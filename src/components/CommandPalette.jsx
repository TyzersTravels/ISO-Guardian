...
const CommandPalette = () => {
  ...
  const commands = useMemo(() => {
    const items = [
      ...
      { id: 'context-analysis', label: 'Context Analysis (SWOT)', keywords: 'swot context internal external issues pestle 4.1 strengths weaknesses opportunities threats', section: 'Navigation', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', action: () => navigate('/context-analysis') },
      ...
      { id: 'legal-register', label: 'Legal Register', keywords: 'legal legislation regulation compliance obligations permit licence 6.1.3 act law', section: 'Navigation', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', action: () => navigate('/legal-register') },
      { id: 'environmental-aspects', label: 'Environmental Aspects', keywords: 'environmental aspects impacts significance 6.1.2 14001 emissions waste water air pollution', section: 'Navigation', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', action: () => navigate('/environmental-aspects') },
      { id: 'hazard-register', label: 'HIRA / Hazard Register', keywords: 'hira hazard identification risk assessment 6.1.2 45001 safety controls hierarchy ppe elimination substitution engineering administrative', section: 'Navigation', icon: 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z', action: () => navigate('/hazard-register') },
      { id: 'clause-matrix', label: 'Clause Cross-Reference Matrix', keywords: 'clause matrix cross reference gap analysis audit readiness evidence mapping', section: 'Navigation', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', action: () => navigate('/clause-matrix') },
